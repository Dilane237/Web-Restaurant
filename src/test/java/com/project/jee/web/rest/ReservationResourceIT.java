...
public class ReservationResourceIT {
    ...
    private static final Long DEFAULT_TABLES = 1L;
    private static final Long UPDATED_TABLES = 2L;
    ...
    private static final Instant DEFAULT_RESERVATION_TIME = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_RESERVATION_TIME = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public void getAllReservations() throws Exception {
        ...
        restReservationMockMvc.perform(get("/api/reservations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tables").value(hasItem(DEFAULT_TABLES.intValue())))
            .andExpect(jsonPath("$.[*].reservedAt").value(hasItem(DEFAULT_RESERVED_AT.toString())))
            .andExpect(jsonPath("$.[*].reservationTime").value(hasItem(DEFAULT_RESERVATION_TIME.toString())));
    }
    ...
    public void getReservation() throws Exception {
        ...
        restReservationMockMvc.perform(get("/api/reservations/{id}", reservation.getId()))
            ...
            .andExpect(jsonPath("$.tables").value(DEFAULT_TABLES.intValue()))
            .andExpect(jsonPath("$.reservedAt").value(DEFAULT_RESERVED_AT.toString()))
            .andExpect(jsonPath("$.reservationTime").value(DEFAULT_RESERVATION_TIME.toString()));
    }
